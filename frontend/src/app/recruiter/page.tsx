      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-[#1B3D34] pb-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-lg p-1 text-xs font-medium">
              <button
                onClick={() => setActiveTab('console')}
                className={`px-3 py-1.5 rounded-md transition cursor-pointer ${
                  activeTab === 'console'
                    ? 'bg-[#0C2B24] dark:bg-[#10B981] text-white dark:text-[#071410] font-semibold shadow-xs'
        ...
        {activeTab === 'console' ? (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              <div className="bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-xl p-5 shadow-xs space-y-1">
            ...
            <div className="bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-xl p-6 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center pt-2">
                {[
                  ...
                  <div key={idx} className="bg-[#F8FAF9] dark:bg-[#071410] border border-slate-200 dark:border-[#1B3D34] rounded-lg p-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-8 bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-xl p-6 shadow-xs space-y-4">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-[#1B3D34] pb-3">
                  ...
                  <Link href="/recruiter/jobs" className="text-xs font-semibold text-emerald-700 dark:text-emerald-400 hover:underline">
                    ...
                    <table className="w-full text-left text-xs">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-[#1B3D34] text-slate-700 dark:text-slate-300">
                        {jobs.slice(0, 5).map((j) => (
                          <tr key={j.id} className="hover:bg-slate-50/50 dark:hover:bg-[#14332B]/30">
                            <td className="py-3 px-3 font-medium text-slate-900 dark:text-white">
                              <Link href={`/recruiter/jobs/${j.id}/ranking`} className="hover:text-emerald-600 dark:hover:text-emerald-400 hover:underline">
                                {j.title}
                              </Link>
                            </td>
              ...
              <div className="lg:col-span-4 bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-xl p-6 shadow-xs space-y-4">
                <h3 className="text-sm font-semibold text-slate-900 dark:text-white">Đơn Ứng Tuyển Mới Nhất</h3>

                {applications.length > 0 ? (
                  <div className="space-y-3 text-xs">
                    {applications.slice(0, 4).map((app) => (
                      <div key={app.id} className="p-3 bg-[#F8FAF9] dark:bg-[#071410] border border-slate-200 dark:border-[#1B3D34] rounded-lg flex items-center justify-between">
                        ...
                        <span className="px-2 py-0.5 rounded-full text-[10px] font-bold font-mono bg-emerald-50 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-800">
                          {app.status}
                        </span>
                      </div>
                    ))}
          ...
          <div className="space-y-6">
            <div className="bg-white dark:bg-[#0E241E] border border-slate-200 dark:border-[#1B3D34] rounded-xl p-6 shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                <div className="p-4 rounded-xl bg-[#F8FAF9] dark:bg-[#071410] border border-slate-200 dark:border-[#1B3D34] space-y-1">
                  ...
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400">100% Top-tier candidate alignment</span>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#F8FAF9] dark:bg-[#071410] border border-slate-200 dark:border-[#1B3D34] space-y-1">
                  ...
                  <span className="text-[10px] text-emerald-600 dark:text-emerald-400">Recall 100% on technical benchmark</span>
                </div>
