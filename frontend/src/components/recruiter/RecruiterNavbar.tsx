  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-[#0B1329]/95 backdrop-blur-md border-b border-[#E2E8F0] dark:border-[#1E293B] text-[#1E3A5F] dark:text-[#D6E4E1] transition-colors">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 xl:gap-3 shrink-0">
            ...
            <div className="hidden md:flex items-center gap-2 pl-2 border-l border-[#E2E8F0] dark:border-[#1E293B] shrink-0">
              <div className="text-right">
                ...
                <span className="text-[10px] font-mono font-bold text-[#B45309] dark:text-[#FACC15] bg-[#FEF3C7] dark:bg-[#FACC15]/15 px-1.5 py-0.5 rounded border border-[#FACC15]/40 uppercase inline-block">
                  HR
                </span>
              </div>
        ...
        {isMobileMenuOpen && (
          <div className="fixed top-16 left-0 right-0 max-h-[calc(100vh-4rem)] overflow-y-auto bg-white dark:bg-[#0B1329] border-b border-[#E2E8F0] dark:border-[#1E293B] p-5 shadow-2xl space-y-4 z-50 lg:hidden animate-fade-in">
