...
class RealityMatchingManipulationTest {
    ...
    void testNoGitHubPenalty_CandidateA_Core80_NoGitHub_OverallIs80Not68() {
        ...
        // MidCV fallback architecture guarantees:
        double midcvOverall = candACore;
        assertEquals(80.0, midcvOverall, "Candidate with no GitHub must receive exactly Core score (80.0), NOT penalized 68.0");
    }
